...
const pushItems = [
  ...
  },
  {
    ...
    color: '#FF1B8D',
    link: 'https://www.instagram.com/edm_army_/',
    linkLabel: '@edm_army_',
  },
];
              ...
              <div>
                ...
                {item.link && (
                  <a
                    ...
                    className="mt-3 inline-flex items-center gap-2 rounded-full border px-4 py-2 text-xs font-bold uppercase tracking-[1.5px] transition-colors duration-200 cursor-pointer hover:bg-[#FF1B8D] hover:text-[#0C140C]"
                  ...
                  >
                    ...
                    {item.linkLabel ?? 'Follow on Instagram'}
                  </a>
                )}
              </div>
