    ...
    <section ref={ref as React.RefObject<HTMLElement>} className="container py-20 md:py-28">
      ...
      <div className="mt-8 grid gap-3 md:mt-12 md:grid-cols-2">
        {useCases.map((uc, i) => (
          ...
          >
            <div className="h-full px-5 py-5 md:p-[23px] md:pr-[39px] flex flex-col gap-y-3 md:gap-y-4 rounded-[18px] border border-[#182B18] bg-[#060A06] md:rounded-[24px]">
              ...
              <p className="text-base leading-[22px] text-[#728A72]">{uc.desc}</p>
            </div>
          </div>
        ))}
      </div>
